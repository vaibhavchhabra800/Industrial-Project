...
public class ButtonColumn extends JFrame {
	...
	table.getColumnModel().getColumn(1).setCellRenderer((TableCellRenderer) new ButtonRendererz());;
...
class ButtonRendererz   extends JButton implements  TableCellRenderer
{

	//CONSTRUCTOR
	public ButtonRendererz() {
